...
public class HttpHelper {
    ...
    /** Default name for the {@link org.opensaml.util.storage.StorageService} partition which holds {@link edu.internet2.middleware.shibboleth.idp.authn.LoginContext}s: {@value} . */
