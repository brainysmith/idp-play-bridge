...
package com.identityblitz.shibboleth.idp.profile;
 ...
 */
public class SAMLMetadataProfileHandlerIB extends AbstractRequestURIMappedProfileHandler<InTransport, OutTransport> {

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(SAMLMetadataProfileHandlerIB.class);
