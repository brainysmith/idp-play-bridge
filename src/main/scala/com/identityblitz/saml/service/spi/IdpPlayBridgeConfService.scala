 ...
 */
trait IdpPlayBridgeConfService {
  ...
  /**
   * Returns the function which returns the logout page to shown users.
   * @return
   */
  def logoutPage: ((Seq[(String, String, String, Boolean)], Request[_]) => Html)
